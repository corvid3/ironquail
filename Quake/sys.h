...
qboolean
Sys_GetAltUserPrefDir(qboolean remastered, char* path, size_t pathsize);
...
Sys_Quit(void);
FUNC_NORETURN void
Sys_ReportError(const char* error, ...) FUNC_PRINTF(1, 2);
...
void
Sys_Printf(const char* fmt, ...) FUNC_PRINTF(1, 2);
