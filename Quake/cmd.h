...
#define Cmd_AddCommand(cmdname, func)                                          \
  Cmd_AddCommand2(cmdname, func, src_command, false) // regular console commands
#define Cmd_AddCommand_ClientCommand(cmdname, func)                            \
  Cmd_AddCommand2(cmdname,                                                     \
                  func,                                                        \
                  src_client,                                                  \
                  false) // command is meant to be safe for anyone to execute.
#define Cmd_AddCommand_ServerCommand(cmdname, func)                            \
  Cmd_AddCommand2(cmdname, func, src_server, false) // command came from a
                                                    // server
