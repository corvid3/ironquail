...
#define TEXPREF_ALPHABRIGHT                                                    \
  0x4000 // use palette with lighting mask in alpha channel (0=fullbright,
         // 1=lit)
#define TEXPREF_CLAMP 0x8000 // clamp UVs

#define TEXPREF_HASALPHA                                                       \
  (TEXPREF_ALPHA | TEXPREF_ALPHABRIGHT) // texture has alpha channel
...
typedef enum
{
  ...
  SOFTEMU_COARSE, // world-space dither nearby, screen-space dither in the
                  // distance
