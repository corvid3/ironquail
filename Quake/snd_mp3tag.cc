...
static qboolean
is_id3v2(const unsigned char* data, size_t length)
{
...
static long
get_id3v2_len(const unsigned char* data, long length)
{
...
static qboolean
is_apetag(const unsigned char* data, size_t length)
{
...
static long
get_ape_len(const unsigned char* data)
{
  unsigned int flags, version;
  long size =
    (long)((data[15] << 24) | (data[14] << 16) | (data[13] << 8) | data[12]);
  version =
    (unsigned)((data[11] << 24) | (data[10] << 16) | (data[9] << 8) | data[8]);
...
static inline int
is_lyrics3tag(const unsigned char* data, long length)
{
...
static long
get_lyrics3v1_len(snd_stream_t* stream)
{
  const char* p;
  long i, len;
  char buf[5104];
...
static inline long
get_lyrics3v2_len(const unsigned char* data, long length)
{
...
static inline qboolean
verify_lyrics3v2(const unsigned char* data, long length)
{
  if (length < 11)
    return false;
...
static qboolean
is_musicmatch(const unsigned char* data, long length)
{
...
static long
get_musicmatch_len(snd_stream_t* stream)
{
...
static int
probe_id3v1(snd_stream_t* stream, unsigned char* buf, int atend)
{
...
static int
probe_mmtag(snd_stream_t* stream, unsigned char* buf)
{
  long len;
...
static int
probe_apetag(snd_stream_t* stream, unsigned char* buf)
{
  long len;
...
static int
probe_lyrics3(snd_stream_t* stream, unsigned char* buf)
{
  long len;
...
int
mp3_skiptags(snd_stream_t* stream)
{
