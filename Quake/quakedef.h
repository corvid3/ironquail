...
#define IRONWAIL_VER_SUFFIX // optional version suffix string literal like
                            // "-beta1"
#endif
...
#define IRONWAIL_VER_STRING                                                    \
  QS_STRINGIFY(IRONWAIL_VER_MAJOR)                                             \
  "." QS_STRINGIFY(IRONWAIL_VER_MINOR) "." QS_STRINGIFY(IRONWAIL_VER_PATCH)    \
    IRONWAIL_VER_SUFFIX

// SDL version the code was compiled with
#define Q_SDL_COMPILED_VERSION_STRING                                          \
  QS_STRINGIFY(SDL_MAJOR_VERSION)                                              \
  "." QS_STRINGIFY(SDL_MINOR_VERSION) "." QS_STRINGIFY(SDL_PATCHLEVEL)
...
Host_Shutdown(void);
void
Host_Callback_Notify(cvar_t* var); /* callback function for CVAR_NOTIFY */

FUNC_NORETURN void
Host_ReportError(const char* error, ...) FUNC_PRINTF(1, 2);
FUNC_NORETURN void
Host_EndGame(const char* message, ...) FUNC_PRINTF(1, 2);
#ifdef __WATCOMC__
...
Host_Quit_f(void);
void
Host_ClientCommands(const char* fmt, ...) FUNC_PRINTF(1, 2);
void
